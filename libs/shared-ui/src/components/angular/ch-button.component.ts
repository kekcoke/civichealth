...
@Component({
  ...
  styles: [`
    ...
    .btn-primary   { background: #0f62fe; color: #ffffff; }
    .btn-primary:hover  { background: #0050e6; }
    .btn-primary:active { background: #002d9c; }
    .btn-secondary { background: #161616; color: #ffffff; }
    .btn-secondary:hover { background: #262626; }
    .btn-tertiary  { background: #ffffff; color: #0f62fe; border: 1px solid #0f62fe; }
    .btn-tertiary:hover  { background: #f4f4f4; }
    .btn-ghost     { background: transparent; color: #0f62fe; }
    .btn-ghost:hover     { background: #f4f4f4; }
    .btn-danger    { background: #da1e28; color: #ffffff; }
    .btn-danger:hover    { background: #ba1b23; }
    button:disabled { background: #e0e0e0; color: #8c8c8c; cursor: not-allowed; }
